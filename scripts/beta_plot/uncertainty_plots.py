...
def plot_beta_against_lambda_m_w() -> None:
...
def plot_uncertainty_against_lambda_m_w() -> None:
...
def evaluate_equilibrium_uncertainty_free(
    ...
    return uncertainty_from_R(equilibrium_R)
...
if __name__ == "__main__":
    plot_beta_against_lambda_m_w()
    plot_beta_against_lambda_w()
    plot_uncertainty_against_lambda_w()
    plot_uncertainty_against_lambda_m_w()
